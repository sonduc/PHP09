...
if(is_numeric($_GET['p']))
	$p=$_GET['p'];
$sta=($p-1)*20;
$partnerlist=$partner->GetCategory('status=1 limit '.$sta.",20");
$tongdong=$partner->CountPartner("status=1");
...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="?page=partners" class="current"><span><?php echo partnerelements?></span></a></li>
...
<!-- TABS END -->    
  ...
  <div class="grid_16" id="content">
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="inner content">Đối tác</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
        ...
        <input value="0" type="hidden" name="txtsubmit" id="txtsubmit">
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
            ...
            <?php for($i=0;$i<count($partnerlist);$i++){?>
              <tr>
                <td width="34"><label>
                    <input type="checkbox" name="checkbox[]" id="checkbox" value="<?php echo $partnerlist[$i][0]?>">
                </label></td>
              ...
              <?php } ?>            
              <tr class="footer">
                <td colspan="4"><a href="#" class="edit_inline">Edit all</a><a href="javascript:submitfrom()" class="delete_inline">Delete all</a><a href="#" class="approve_inline">Approve all</a><a href="#" class="reject_inline">Reject all</a></td>
                <td align="right">&nbsp;</td>
