				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="?mod=salesmans&act=list"><i class="fa fa-user"></i> Account</a></li>
								<li><a href="?mod=clients&act=list"><i class="fa fa-star"></i> Clients</a></li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="?mod=products" class="active">Home</a></li>
