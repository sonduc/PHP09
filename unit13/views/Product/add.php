...
<div  id="page-wrapper">
	...
	<form action="?mod=products&act=store" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="text" placeholder="Nhập tên sản phẩm" name="slug">
		</div>
		
		<div class="form-group">
			<label for="name">Category_id:</label>
			<input type="text" class="form-control" id="text" placeholder="Nhập tên sản phẩm" name="category_id">
		</div>
		<!-- <div class="form-group">
